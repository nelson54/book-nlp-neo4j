...
public class SyntaxAnnotator {
	...
	public AnnotationTokens process(String doc)
			throws Exception {
		...
		AnnotationTokens annotationTokens = new AnnotationTokens(document, allWords);

		return annotationTokens;

	}

	public static String getPath(int s, int t, List<Token> allWords) {
